...
{
    public class FamilyMembersListPage
    {
        IWebDriver _webDriver;
        public string PageUrl => _webDriver.Url;
        public FamilyMembersListPage(IWebDriver driver)
        {
            _webDriver = driver;
            _webDriver.Navigate().GoToUrl("https://localhost:7202/FamMembers");
